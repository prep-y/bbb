            ...
            <tbody>
                ...
                ?>
                    <tr class="bg-primary">
                        ...
                        <td class="text-white">Parent</td>
                        <td>
                            <a href="categories.php?edit=<?=$parent['id'];?>" class="btn btn-xs btn-default"><i class="large material-icons">create</i></a>
                            <a href="categories.php?delete=<?=$parent['id'];?>" class="btn btn-xs btn-default"><i class="large material-icons">delete</i></a>
                        </td>
                    </tr>
                    <?php while($child = mysqli_fetch_assoc($cResult)): ?>
                        ...
                        <td class="text-white"><?=$parent['category'];?></td>
                        <td>
                            <a href="categories.php?edit=<?=$child['id'];?>" class="btn btn-xs btn-default"><i class="large material-icons">create</i></a>
                            <a href="categories.php?delete=<?=$child['id'];?>" class="btn btn-xs btn-default"><i class="large material-icons">delete_sweep</i></a>
                        </td>
                    </tr>
                    <?php endwhile;?>
                <?php endwhile; ?>
